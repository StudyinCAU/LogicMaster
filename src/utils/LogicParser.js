	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 5:
	                    ...
	                    this.state = 31;
	                    localctx.op = this.match(LogicParser.XOR);
	                    this.state = 32;
	                    this.expr(5);
	                    break;

	                case 6:
	                    localctx = new XnorContext(this, new ExprContext(this, _parentctx, _parentState));
	                    this.pushNewRecursionContext(localctx, _startState, LogicParser.RULE_expr);
	                    this.state = 33;
	                    ...
	                    this.state = 34;
	                    localctx.op = this.match(LogicParser.XNOR);
	                    this.state = 35;
	                    this.expr(4);
	                    break;
...
class XnorContext extends ExprContext {
	...
	XNOR() {
	    return this.getToken(LogicParser.XNOR, 0);
	};

	enterRule(listener) {
	    if(listener instanceof LogicListener ) {
	        listener.enterXnor(this);
		}
	}

	exitRule(listener) {
	    if(listener instanceof LogicListener ) {
	        listener.exitXnor(this);
		}
	}
...
LogicParser.XnorContext = XnorContext;
...
class XorContext extends ExprContext {
...
LogicParser.XorContext = XorContext;
